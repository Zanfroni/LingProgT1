...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_INSIDE2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:570:14: ( ( RULE_ANY_OTHER | RULE_INTEGER ',' ) )
            // InternalMyDsl.g:570:16: ( RULE_ANY_OTHER | RULE_INTEGER ',' )
            {
            // InternalMyDsl.g:570:16: ( RULE_ANY_OTHER | RULE_INTEGER ',' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:570:17: RULE_ANY_OTHER
                    {
                    mRULE_ANY_OTHER(); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:570:32: RULE_INTEGER ','
                    {
                    mRULE_INTEGER(); 
                    match(','); 
    ...
    public final void mRULE_ADD2() throws RecognitionException {
        try {
            int _type = RULE_ADD2;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:572:11: ( ( RULE_ANY_OTHER | RULE_INTEGER '+' ) )
            // InternalMyDsl.g:572:13: ( RULE_ANY_OTHER | RULE_INTEGER '+' )
            {
            // InternalMyDsl.g:572:13: ( RULE_ANY_OTHER | RULE_INTEGER '+' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalMyDsl.g:572:14: RULE_ANY_OTHER
                    {
                    mRULE_ANY_OTHER(); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:572:29: RULE_INTEGER '+'
                    {
                    mRULE_INTEGER(); 
                    match('+'); 
    ...
    public final void mRULE_CONTENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:574:14: ( RULE_INTEGER '(' RULE_ID ')' RULE_PRINT )
            // InternalMyDsl.g:574:16: RULE_INTEGER '(' RULE_ID ')' RULE_PRINT
            {
            mRULE_INTEGER(); 
            match('('); 
            mRULE_ID(); 
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:576:14: ( RULE_INT )
            // InternalMyDsl.g:576:16: RULE_INT
            {
            mRULE_INT(); 
    ...
    public final void mRULE_PRINT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:578:12: ( ' ++ \" ' RULE_ID '!\"' )
            // InternalMyDsl.g:578:14: ' ++ \" ' RULE_ID '!\"'
            {
            match(" ++ \" "); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            // InternalMyDsl.g:580:18: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:580:20: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalMyDsl.g:580:49: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalMyDsl.g:582:19: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:582:21: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:582:21: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:584:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:584:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:584:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalMyDsl.g:584:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:584:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:584:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:584:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:586:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:586:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:586:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:588:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:588:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:588:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:590:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:590:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:590:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            // InternalMyDsl.g:592:25: ( . )
            // InternalMyDsl.g:592:27: .
            {
            matchAny(); 
