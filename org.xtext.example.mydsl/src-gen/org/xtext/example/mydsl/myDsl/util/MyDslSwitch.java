...
public class MyDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case MyDslPackage.COMPLEMENT:
      {
        ...
        if (result == null) result = caseFunction(complement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        NewConcat newConcat = (NewConcat)theEObject;
        T result = caseNewConcat(newConcat);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>New Concat</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>New Concat</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseNewConcat(NewConcat object)
  {
    return null;
  }
